...
public interface API extends com.uptang.cloud.core.Constants {
    ...
    interface Manager {
         ...
         * 任务是否开放接口
         */
        String MODULE_SWITCH = "%s/api/everyday/page_module_switch";
    ...
    interface UserCenter {
         ...
         * 学生信息查询接口
         */
        String STUDENT_INFO = "%s/api/base/student/studentList.action";
    ...
    interface Promission {
         ...
         * 当前用户权限校验接口
         */
        String CHECK = "%s/api/base/baseUser/sessionuser";
    }
    ...
    interface Grade {
         ...
         */
        String INFO = "%s/api/base/subject/detail/%d";
    }
     ...
     * @return
     */
    static String getApi(String serverHost, String api, String... param) {
