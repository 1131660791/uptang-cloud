...
import com.uptang.cloud.base.common.vo.AreaVO;
...
import com.uptang.cloud.starter.web.annotation.AuthPolicy;
import com.uptang.cloud.starter.web.annotation.Authenticate;
 ...
 * 需要排除字段的使用方式：
 * <pre>
 *   @JsonResult(type = AreaVO.class, exclude = {"createdTime", "modifiedTime"})
 * </pre
 *
 * @author Jiang Chuan
 * @version 4.0.0
