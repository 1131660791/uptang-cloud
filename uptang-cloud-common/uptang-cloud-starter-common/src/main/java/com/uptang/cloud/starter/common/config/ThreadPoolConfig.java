package com.uptang.cloud.starter.common.config;
...
public class ThreadPoolConfig {
     ...
     * @return
     */
    @Bean("subjectExecutor")
    public ThreadPoolTaskExecutor subjectExecutor() {
        ThreadPoolTaskExecutor executor = new ThreadPoolTaskExecutor();
        ...
        // 线程池名的前缀：设置好了之后可以方便我们定位处理任务所在的线程池
        executor.setThreadNamePrefix("BATCH-INSERT-SUBJECT-");
