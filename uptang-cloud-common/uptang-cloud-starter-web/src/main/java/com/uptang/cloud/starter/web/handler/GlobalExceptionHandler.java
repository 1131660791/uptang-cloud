...
public class GlobalExceptionHandler {
    ...
    public ApiOut handleAuthenticationException(HttpServletRequest request, AuthenticationException exception) {
        ResponseCodeEnum responseCode = Optional.ofNullable(ResponseCodeEnum.parse(exception.getCode())).orElse(ResponseCodeEnum.UNAUTHORIZED);
    ...
    public ApiOut handleThrowable(HttpServletRequest request, Throwable ex) {
        ...
        if (ex instanceof BusinessException) {
            ...
            if (NumberUtils.isPositive(exception.getCode())) {
                responseCode = ResponseCodeEnum.parse(exception.getCode());
